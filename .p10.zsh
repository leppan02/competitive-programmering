# Generated by Powerlevel10k configuration wizard on 2020-09-22 at 12:47 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    ram                   # free RAM
    # swap                  # used swap
    todo                    # todo items (https://github.com/todotxt/todo.txt-cli)            # timewarrior tracking status (https://timewarrior.net/)
